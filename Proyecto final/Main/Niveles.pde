...
void nivelme11() {
  ...
  pa[7] = new Pared(puerta[2].x-puerta[2].ly, puerta[2].y-puerta[2].esp/2, puerta[2].ly, puerta[2].lx);
...
void nivel10() {
  ...
  for (int i = 0; i < pa.length; i++) {
    ...
    case 3:
      pa[i] = new Pared(690, 20, 510, 20);//superior rigth
      break;

    case 4:
      pa[i] = new Pared(20, 20, 510, 20);//superior left
      break;
  ...
  pa[7] = new Pared(puerta[1].x-puerta[1].esp/2, puerta[1].y, puerta[1].lx, puerta[1].ly);
  pa[8] = new Pared(puerta[1].x+puerta[1].lx+puerta[1].esp/2, puerta[1].y, puerta[1].lx, puerta[1].ly);
  fill(50);
  puerta[1].display();
  puerta[1].mov(key ==' ');
}
